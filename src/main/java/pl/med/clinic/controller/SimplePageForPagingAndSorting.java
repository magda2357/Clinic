...
public class SimplePageForPagingAndSorting<T> extends PageImpl<T> {

    @JsonCreator
    public SimplePageForPagingAndSorting(@JsonProperty("content") final List<T> content,
        ...
        super(content, PageRequest.of(page, size, Sort.by(sort
                .stream()
                .map(el -> el.split(","))
    ...
    public SimplePageForPagingAndSorting(final List<T> content, final long totalElements, final Pageable pageable) {
